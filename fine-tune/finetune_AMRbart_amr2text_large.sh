...
export OUTPUT_DIR_NAME=outputs/$datacate-AMRBart-$modelcate-amr2text-6taskPLM-5e-5-finetune-lr${lr}-AMREOS-V100
#export OUTPUT_DIR_NAME=outputs/$datacate-AMRBart-$modelcate-amr2text-STD-finetune-lr${lr}
